export default {
  ...
  deleteAccount: {
    ...
    formTitle: "Een wissing aanvragen",
    formSubtitle: "Vul dit in en we verwerken het binnen 30 dagen.",
    formEmailLabel: "Je e-mailadres",
    formEmailPlaceholder: "jan@mail.com",
    formNicknameLabel: "Nickname of teamnaam (optioneel)",
    formNicknamePlaceholder: "Zoals die in de app verscheen",
    formReasonLabel: "Nog iets om te vermelden? (optioneel)",
    formReasonPlaceholder: "Geschatte datum van de laatste partij, enz.",
