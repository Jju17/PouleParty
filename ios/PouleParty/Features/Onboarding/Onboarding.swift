        ...
        Reduce { state, action in
            ...
            case .nextButtonTapped:
                if state.currentPage == Self.locationPageIndex {
                    guard state.locationAuthorizationStatus.isUsable else { return .none }
                }
                ...
                if state.currentPage < Self.totalPages - 1 {
                    ...
                    guard state.locationAuthorizationStatus.isUsable else {
            ...
            case let .pageChanged(page):
                let locAuthorized = state.locationAuthorizationStatus.isUsable
            ...
            VStack {
                ...
                VStack(spacing: 20) {
                    ...
                    HStack {
                        ...
                        let isLocationPageBlocked = store.currentPage == 3 && !store.locationAuthorizationStatus.isUsable
