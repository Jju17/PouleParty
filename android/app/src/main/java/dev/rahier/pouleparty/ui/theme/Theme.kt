...
private val DarkColorScheme = darkColorScheme(
    ...
    surfaceVariant = CRDarkSurfaceVariant,
    onSurfaceVariant = CRDarkOnSurfaceVariant,
    secondaryContainer = CRDarkSecondaryContainer,
    onSecondaryContainer = Color.White,
    outline = CRDarkOutline,
    outlineVariant = CRDarkOutline,
